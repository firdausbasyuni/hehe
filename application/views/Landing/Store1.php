...
<div class="row" style="background-color: #D3D3D3; height: ">
        ...
        <div class="col-md-9">
          ...
          <img src="https://www.schofficial.com/Content/frontend/img/store/1.jpg?v=1" class="img-full" style="height: 600px">
        
      </div>
      <div class="col-md-3" style="color: black; text-align: left;">
        <h1 style="margin-top: 80px; margin-right: 30px; margin-left: 40px; font-size: 25px;">Exhibition Room 1 Buah Batu</h1>
        <hr style="margin-left: 40px;">
        
        <div>
          <h1 style="color: black; font-size: 17px; font-weight: bold; margin-left: 40px;">ADDRESS: </h1>
          <h1 style="font-size: 12px; margin-left: 40px;">Jl.Buah Batu no.64 Bandung</h1>
          ...
          <h1 style="font-size: 12px; margin-left: 40px;">+622.730.6697</h1>
