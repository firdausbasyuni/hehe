...
<div class="row" style="background-color: #D3D3D3; height: ">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="https://www.schofficial.com/Content/frontend/img/store/5.jpg?v=1" class="img-full" alt="First slide">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="col-md-3" style="color: black; text-align: left;">
        <h1 style="margin-top: 80px; margin-right: 30px; margin-left: 40px; font-size: 25px;">Exhibition Room 5 Tebet</h1>
        <hr style="margin-left: 40px;">
        
        <div>
          <h1 style="color: black; font-size: 17px; font-weight: bold; margin-left: 40px;">ADDRESS: </h1>
          <h1 style="font-size: 12px; margin-left: 40px;">Jl.Tebet utara dalam No.26 Jakarta Selatan</h1>
          ...
          <h1 style="font-size: 12px; margin-left: 40px;">+6221.831.2677</h1>
